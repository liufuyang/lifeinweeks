<template>
  <div class="sandbox">
    ...
    <md-card>
      <md-card-header>
        <div class="md-title">
          Material Design with Vue.js 2 Demo Card
        </div>
      ...
      <md-card-content>
        <md-button class="md-raised md-primary" v-on:click.native="fillTable()">Fill
        </md-button>
  ...
  methods: {
    fillTable: function () {
      ...
      this.contacts.push({
        name: 'Johannes',
        phone: '44332211',
        email: 'doom@google.com'
      })
    },
    clearTable: function () {
      console.log('fillTable clicked')
...
function callNTimes (obj, func, num, delay) {
  if (!num) return
  func(obj)
  setTimeout(function () { callNTimes(obj, func, num - 1, delay) }, delay)
}
</script>
